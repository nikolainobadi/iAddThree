...
extension GameManagerTests {
    class MockStore: GameStore {
        ...
        private let completedLevelsCount: Int
        ...
        init(modeLevel: Int, highScore: Int, completedLevelsCount: Int, unlockedAchievements: [GameAchievement]) {
            self.modeLevel = modeLevel
            self.highScore = highScore
            self.completedLevelsCount = completedLevelsCount
